...
class Config(object):
	...
	ABOUT_BOT_TEXT = f"""
This is a Permanent FileStreamBot. 
Send Me any Media or File.I can Work In Channel too Add Me to Channel with Edit Permission, I will add save Uploaded File in Channel and Share a Shareable Link. 

╭────[ **🔅FɪʟᴇSᴛᴏʀᴇBᴏᴛ🔅**]────⍟
│
├🔸🤖 **My Name:** [𝐅𝐢𝐥𝐞𝐒𝐭𝐫𝐞𝐚𝐦𝐁𝐨𝐭](https://t.me/{BOT_USERNAME})
│
...
│
├🔸👨‍💻 **Developer:** [@𝐊𝐢𝐫𝐨𝐝𝐞𝐰𝐚𝐥](https://t.me/Kirodewal) 
│
├🔹👥 **Bot Support:** [𝐒𝐮𝐩𝐩𝐨𝐫𝐭](https://t.me/HxSupport)
│
├🔸🔔 **Bot Updates:** [𝐔𝐩𝐝𝐚𝐭𝐞𝐬](https://Hxbots)
│
╰──────[ 😎 ]───────────⍟
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 **𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:** [@𝐊𝐢𝐫𝐨𝐝𝐞𝐰𝐚𝐥](https://t.me/Kirodewal) 
...
[**Donate Me**](https://upayme.vercel.app/hxbots@pingpay) (𝐔𝐏𝐈)
"""
	HOME_TEXT = """
Hello, [{}](tg://user?id={})\n\nThis is a Permanent **FileStreamBot**.
